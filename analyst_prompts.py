...
"---\n\n"
"VERDETTO:\n"
"COMPRA FORTE: rendimento atteso >30% in 3 anni, margine di sicurezza elevato, tesi robusta e downside "
"limitato.\n"
"COMPRA: rendimento atteso >15–20% in 3 anni con rischio accettabile.\n"
"ASPETTA: qualità buona ma rendimento atteso insufficiente o valutazione piena.\n"
"VENDI: rendimento atteso negativo o rapporto rischio/rendimento sfavorevole.\n\n"
"Prima di emettere il verdetto, assegna un punteggio di attrattività dell'investimento (0-100) basato sul "
"rapporto rendimento atteso/rischio. Il verdetto deve essere coerente con questo punteggio:\n"
"85–100 → COMPRA FORTE\n"
"70–84 → COMPRA\n"
"50–69 → ASPETTA\n"
"<50 → VENDI\n\n"
...
POWER = {
    ...
    "short": {
        ...
        "task": (
            ...
            "## Expected Move\nStima il movimento atteso del prezzo (% e range probabile, non solo un numero secco) su "
            "tre orizzonti separati: 7 giorni; 15 giorni; 30 giorni. Basati su volatilità implicita/storica, catalizzatori "
            "attesi in ciascuna finestra e la tesi ribassista — l'ampiezza deve crescere in modo coerente con l'orizzonte.\n\n"
            ...
            "## Metodo Migliore\nRaccomanda UNA modalità di esecuzione tra: Short diretto (azione); Put; Bear Put Spread; "
            "Nessun trade (se tesi o tempistica non giustificano l'esecuzione ora). Motiva la scelta considerando costo "
            "del capitale/borrow, rischio di squeeze, costo e liquidità delle opzioni, IV percentile.\n\n"
            ...
            "## Short Attractiveness Score (0-100)\nSintetizza in UN unico punteggio 0-100 quanto è conveniente questo "
            "short nel complesso (tesi + rischio/rendimento + posizionamento). Bande: 0-30 = Non shortabile; 30-50 = Debole; "
            "50-70 = Interessante; 70-85 = Forte; 85-100 = Eccezionale. Deve essere coerente con la Raccomandazione finale.\n\n"
            "## Short Timing Score (0-10)\nUna tesi può essere corretta nella direzione ma sbagliata nel momento (es. "
            "Tesla ribassista ma nel momento sbagliato). Valuta SOLO la tempistica d'ingresso adesso, separatamente dalla "
            "qualità della tesi: 0-3 = momento sbagliato, aspetta trigger/conferma; 4-6 = tempistica incerta; 7-10 = "
            "momento giusto per entrare ora. Riporta il punteggio come \"Timing X/10\" e motivalo in 1-2 frasi.\n\n"
